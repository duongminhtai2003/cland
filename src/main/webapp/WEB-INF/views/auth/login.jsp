...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/auth/style.css">
</head>
<body>
	...
	<form action="<%=request.getContextPath()%>/auth/login" method="post">
		...
		<div class="inputGroup inputGroup1">
			<c:if test="${not empty param['error']}">
				<p style="color: red; font-size: 20px">Sai tên đăng nhập hoặc mật khẩu</p> <br>
			</c:if>
			<label for="loginEmail" id="loginEmailLabel">Username</label> <input
				type="text" id="loginEmail" maxlength="254" name="username" />
	...
	<script
		src='https://s3-us-west-2.amazonaws.com/s.cdpn.io/16327/GSDevTools.min.js'></script>
	<script src="${pageContext.request.contextPath}/auth/script.js"></script>
